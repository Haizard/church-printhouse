      ...
      <div className="flex min-h-screen flex-col bg-slate-50">
        ...
        <main className="flex-grow container mx-auto px-4 py-12">
          ...
          {loading ? (
            ...
            <Card className="p-20 text-center text-muted-foreground border-none shadow-sm rounded-3xl">
            ...
            <div className="space-y-6">
              {messages?.map((msg) => (
                <Card key={msg.id} className="border-none shadow-sm rounded-2xl overflow-hidden">
